...
import AccelerateCard from "./accelarated-card"
...
const FeatureCard = ({ icon: Icon, title, description, learnMoreLink, className, svgClassName }) => (
  <div
    className={cn(
      "flex relative flex-col justify-start items-start p-10 transform-gpu border-l-[1.2px]",
      className,
    )}
  >
...
export default function FeaturesSection() {
  return (
    <div className="relative my-32 mx-auto rounded-none md:w-full xl:w-4/5 2xl:w-3/5 max-w-[1300px] font-geist md:border-[1.2px]">
      ...
      <div className="grid grid-cols-1 w-full md:grid-cols-3 grid-rows-7 md:grid-rows-6">
        <FeatureCard
          icon={ChartIcon}
          title="Growth"
          description={
      ...
      <PlusIcon className="bottom-[-15px] right-[-15px]" />
        ...
        {/*<div className="relative md:grid md:col-span-3 grid-cols-2 row-span-2 border-b-0 border-t-0 w-full h-full dark:[border:0.01px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_rgb(255_255_255_/_0.05)_inset]">
          ...
          <div className="flex flex-col gap-3 md:flex-col mt-[-100px]">
            <div className="relative hidden md:flex h-[500px] w-[500px] flex-col items-center justify-center overflow-hidden rounded-lg bg-transparent md:shadow-xl">
              <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300 bg-clip-text text-center text-8xl font-semibold leading-none text-transparent dark:from-white dark:to-black">
                Available
              </span>
              
              <AnimatedOrbit duration={20} radius={80} delay={-20}>
              
              </AnimatedOrbit>
              <AnimatedOrbit duration={20} radius={120} delay={-10}>
