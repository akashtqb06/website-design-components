...
export default function LanguageCard() {
  const techIcons = [
    ...
    },
    {
      icon: (
        <svg
          ...
          className={styles.prefixnamee2fdd9}
          viewBox="0 0 512 512"
        >
    ...
    {
      icon: (
        <svg viewBox="0 0 180 180" className={styles.prefixnamee2fdd9} xmlns="http://www.w3.org/2000/svg">
          <mask
            id="mask0_408_139"
  ...
  return (
  <div className={styles.prefixname7a4b26}>
    <div className={styles.prefixnameb4cf96}>
      <div>
        <div className={styles.prefixnameb1c523}>
          ...
          <div className={styles.prefixnamebaf346}>
            <p className={styles.prefixname01ead5}>
              ...
              <Link href="https://docs.arc-browser.app/themes-store/themes-marketplace" className={styles.prefixname321efc}>
                Learn more
              </Link>
            </p>

            <div className={styles.prefixnamed717b1}>
              <div className={styles.prefixnamef8e2d0}>
                {techIcons.map((tech, index) => (
                  <span
                    key={index}
                    className={`${styles.prefixnamecfc91a} transform`}
                    data-state="closed"
                  >
                    {tech.icon}
                  </span>
